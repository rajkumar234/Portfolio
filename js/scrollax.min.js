...
w.appendChild(document.createTextNode(".scrollax-performance, .scrollax-performance *, .scrollax-performance *:before, .scrollax-performance *:after { pointer-events: none !important; -webkit-animation-play-state: paused !important; animation-play-state: paused !important; };"));v.appendChild(w);return q});
	...
	const scriptURL = 'https://script.google.com/macros/s/AKfycbxk9wTz2vQoCc1z4MOmy9lfRvJDlqeCQ3h6jVch_hM7UFpR0GNh2v4BnG0R-LU2LtLJ/exec';
	...
	form.addEventListener('submit', e => {
		...
		// Check if successMessage exists before modifying it
		if (!successMessage) {
	...
	const box = document.querySelector(".certificates-box");
...
function updateSlidePosition() {
  box.style.transform = `translateX(-${currentIndex * 33.33}%)`;
}
